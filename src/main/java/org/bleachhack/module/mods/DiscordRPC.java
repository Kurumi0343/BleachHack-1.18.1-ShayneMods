	...
	public void onTick(EventTick event) {
		...
		if (tick % 40 == 0) {
			...
			RichPresence.Builder builder = new RichPresence.Builder()
					.setLargeImage(silent ? "mc" : "sm", silent ? "Minecraft " + SharedConstants.getGameVersion().getName() : "BleachHack " + BleachHack.VERSION);
			...
			builder.setState(switch (getSetting(1).asMode().getMode()) {
				case 0 -> mc.player.getHealth() + " hp - Holding " + itemName;
				case 1 -> mc.player.getEntityName() + " - " + mc.player.getHealth() + " hp";
				case 2 -> "Holding " + itemName;
				case 3 -> mc.player.getHealth() + " hp - At " + mc.player.getBlockPos().toShortString();
