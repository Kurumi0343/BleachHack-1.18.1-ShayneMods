	...
	public Killaura() {
		super("Killaura", KEY_UNBOUND, ModuleCategory.COMBAT, "Automatically attacks entities.",
				...
				new SettingToggle("MultiAura", false).withDesc("Atacks multiple entities at once.").withChildren(
						new SettingSlider("Targets", 1, 50, 3, 0).withDesc("How many targets to attack at once.")),
				...
				new SettingSlider("Range", 0, 5, 4.25, 2).withDesc("Attack range."),
				new SettingSlider("CPS", 0, 50, 8, 0).withDesc("Attack CPS if 1.9 delay is disabled."));
	}
