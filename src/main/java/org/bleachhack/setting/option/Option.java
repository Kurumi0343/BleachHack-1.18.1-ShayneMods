...
public abstract class Option<T> extends Setting<T> {
	...
	public static Option<Boolean> PLAYERLIST_SHOW_BH_USERS = new OptionBoolean("Show SM Users", "Shows other BleachHack players on the playerlist.", true);
	public static Option<Boolean> PLAYERLIST_SHOW_AS_BH_USER = new OptionBoolean("Appear As SM User", "Makes you show up as a BleachHack user to others.", true, b -> {
