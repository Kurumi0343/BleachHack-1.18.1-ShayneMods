...
public class UIWindow extends ClickGuiWindow {
	...
	private final Supplier<int[]> sizeSupplier;
	private final TriConsumer<MatrixStack, Integer, Integer> renderConsumer;
	...
	public static class Position {
		...
		private final Object2IntMap<String> attachments = new Object2IntOpenHashMap<>(2);
